<form id="Subphonic">
	<fieldset class="personalblock">
		...
		<div style="position: relative; left: 10px;">
			...
			<?php echo $l->t('Username'); ?> <input type="text" name="user_headphones"  id="user_headphones"  value="<?php echo $_['use    r_headphones']; ?>"  placeholder="<?php echo $l->t('Username'); ?>" /><br />
			...
			API-Key <input type="text" name="apikey_headphones"  id="apikey_headphones"  value="<?php echo $_['a    pikey_headphones']; ?>"  placeholder="<?php echo $l->t('API-Key'); ?>" style="width: 220px;"/>
		</div>
	</fieldset>
</form>
